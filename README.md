...
<p align="center">
  <a href="https://devtools.at/tools/iban-validator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Validate IBAN numbers</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/iban-validator">Try Online</a> •
...
**[Try IBAN Validator online at DevTools.at →](https://devtools.at/tools/iban-validator)**
...
Validate IBAN numbers. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/iban-validator';
